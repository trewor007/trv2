...
class Rules():
    def SMA_EMA(self, produkt_id, zakres, cena, smas_budget, smas_budget2, ema_budget, ema_budget2, smas, rsi, ema, wallet):
        ...
        if ((cena[-1]>smas[-1]) and (cena[-1]<cena[-2]) and (smas_budget["kupiono"]==True) and (smas_budget["BuyPrice"]<cena[-1])): #sprzedawanie
            ...
            wallet[pair[4:]]=round(wallet[pair[4:]]+(smas_budget['coin_amount']*cena[-1]),7)#<--- should be 2 for EUR 
            ...
            wallet[pair[4:]]=round(wallet[pair[4:]]+(smas_budget2['coin_amount']*cena[-1]),7)#<--- should be 2 for EUR 
            ...
            smas_budget['coin_amount']=round_down(((0.1*wallet[pair[4:]])/cena[-1]),7)
            wallet[pair[4:]]=round(wallet[pair[4:]]-(smas_budget['coin_amount']*cena[-1]),7)#<--- should be 2 for EUR 
            wallet[pair[:3]]=round(wallet[pair[:3]]+(smas_budget['coin_amount']),7)
            ...
            smas_budget2['coin_amount']=round_down(((0.1*wallet[pair[4:]])/cena[-1]),7)
            wallet[pair[4:]]=round(wallet[pair[4:]]-(smas_budget2['coin_amount']*cena[-1]),7)#<--- should be 2 for EUR 
            wallet[pair[:3]]=round(wallet[pair[:3]]+(smas_budget2['coin_amount']),7)
        ...
        for i in zakres:
            if len(cena)>i:
                ...
                if ((cena[-1]>ema[j][-1]) and (cena[-1]<cena[-2]) and (ema_budget[j]["kupiono"]==True) and (ema_budget[j]["BuyPrice"]<cena[-1])): #sprzedawanie
                    ...
                    wallet[pair[4:]]=round(wallet[pair[4:]]+(ema_budget[j]['coin_amount']*cena[-1]),7)#<--- should be 2 for EUR 
                    ...
                    wallet[pair[4:]]=round(wallet[pair[4:]]+(ema_budget2[j]['coin_amount']*cena[-1]),7)#<--- should be 2 for EUR 
                    ...
                    ema_budget[j]['coin_amount']=round_down(((0.1*wallet[pair[4:]])/cena[-1]),7)
                    wallet[pair[4:]]=round(wallet[pair[4:]]-(ema_budget[j]['coin_amount']*cena[-1]),7)#<--- should be 2 for EUR 
                    wallet[pair[:3]]=round(wallet[pair[:3]]+(ema_budget[j]['coin_amount']),7)
                    ...
                    ema_budget2[j]['coin_amount']=round_down(((0.15*wallet[pair[4:]])/cena[-1]),7)
                    wallet[pair[4:]]=round(wallet[pair[4:]]-(ema_budget2[j]['coin_amount']*cena[-1]),7)#<--- should be 2 for EUR 
                    wallet[pair[:3]]=round(wallet[pair[:3]]+(ema_budget2[j]['coin_amount']),7)
