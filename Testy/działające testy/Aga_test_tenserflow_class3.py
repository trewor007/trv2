...
class Tensorflow_Model():
    ...
    def model(self, First_Layer_Nod, Second_Layer_Nod, Third_Layer_Nod, Forth_Layer_Nod):
        ...
        tensorboard=TensorBoard(log_dir="logs/models/1L{}_2L{}_3L{}_4L{}".format(First_Layer_Nod, Second_Layer_Nod, Third_Layer_Nod, Forth_Layer_Nod))
                ...
                if Third_Layer_Nod <= Second_Layer_Nod:
                    for Forth_Layer_Nod in Forth_Layer_Nods:
                        if Forth_Layer_Nod <Third_Layer_Nod:
                            TFM=Tensorflow_Model(load_training_data=True, save_training_data=False, load_training_model=False,  multi_stage_test=True, Epochs=10)
                            TFM.data_procesing() 
                            TFM.model(First_Layer_Nod, Second_Layer_Nod, Third_Layer_Nod, Forth_Layer_Nod)
                            clear_session()
                        else:
                            pass
                else:
            ...
            if Second_Layer_Nod > First_Layer_Nod:
                for Third_Layer_Nod in Third_Layer_Nods:
                    if Third_Layer_Nod <= Second_Layer_Nod:
                        for Forth_Layer_Nod in Forth_Layer_Nods:
                            if Forth_Layer_Nod <Third_Layer_Nod:
                                TFM=Tensorflow_Model(load_training_data=True, save_training_data=False, load_training_model=True, multi_stage_test=True, Epochs=30)
                                TFM.data_procesing() 
                                TFM.model(First_Layer_Nod, Second_Layer_Nod, Third_Layer_Nod, Forth_Layer_Nod)
                                clear_session()
                            else:
