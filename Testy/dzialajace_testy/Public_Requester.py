...
'''
-B1-
-naprawiono blad odwracania przy wielokrotnym pobieraniu historii
-B2-
-dodano opóznienie w pętli pobierania danych. powinno to wyeliminwać błąd eypt error slice
'''
