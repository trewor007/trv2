                ...
                if Third_Layer_Nod <= Second_Layer_Nod:
                    for Forth_Layer_Nod in Forth_Layer_Nods:
                        if Forth_Layer_Nod <Third_Layer_Nod:
                            TFM=Tensorflow_Model(load_training_data=True, save_training_data=False, load_training_model=False,  multi_stage_test=True, Epochs=1)
                            TFM.data_procesing() 
